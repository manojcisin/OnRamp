/*
Deployment script for onRampLatest
...
GO
:setvar DatabaseName "onRampLatest"
:setvar DefaultFilePrefix "onRampLatest"
...
GO
PRINT N'Creating [dbo].[FK_Tbl_Orders_Tbl_Product]...';


GO
ALTER TABLE [dbo].[Tbl_Orders]
    ADD CONSTRAINT [FK_Tbl_Orders_Tbl_Product] FOREIGN KEY ([Product_Barcode]) REFERENCES [dbo].[Tbl_Products] ([Product_Barcode]);


GO
PRINT N'Creating [dbo].[FK_Tbl_Orders_Tbl_Suppliers]...';


GO
ALTER TABLE [dbo].[Tbl_Orders]
    ADD CONSTRAINT [FK_Tbl_Orders_Tbl_Suppliers] FOREIGN KEY ([Supplier_ID]) REFERENCES [dbo].[Tbl_Suppliers] ([Supplier_ID]);
