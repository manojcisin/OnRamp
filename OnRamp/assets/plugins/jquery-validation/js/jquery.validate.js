...
(function ($) {
    ...
    $.extend($.fn, {
        ...
        rules: function (command, argument) {
            ...
            if (command) {
                ...
                existingRules = $.validator.staticRules(element.id);
                switch (command) {
                    case "add":
    ...
    $.extend($.validator, {
        ...
        messages: {
            ...
            validpassword: "password required At least one symbol,upper case, lower case,number and no space etc.",
