...
var Metronic = function () {
    ...
    return {
        ...
        blockUI: function (options) {
            ...
            //} else {    
            html = '<div class="loading-message loading-message-boxed"><img src="/assets/img/loading-spinner-default.gif" align="" id="spinner"><span>&nbsp;&nbsp;LOADING...</span></div>';
          ...
          //  }
            ...
            if (options.target) { // element blocking
                ...
                $.blockUI({
                    ...
                    overlayCSS: {
                        backgroundColor: options.overlayColor ? options.overlayColor : '#000',
                        opacity: options.boxed ? 0.05 : 0.7,
                        cursor: 'wait'
                    }
                });
            }            
