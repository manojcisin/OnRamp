...
using OnRamp.BusinessLayer.Repository;
using OnRamp.DataLayer.IRepository;
using OnRamp.DataLayer.Repository;
...
namespace OnRamp.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
			...
			container.RegisterType<IRepositoryOrderBL, RepositoryOrderBL>();
			container.RegisterType<IRepositoryOrder, RepositoryOrder>();
		}
    }
}
